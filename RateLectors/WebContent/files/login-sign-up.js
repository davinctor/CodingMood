    ...
    $signup.validate({
        ...
        rules: {
            ...
            password: {
                ...
                minlength: 4,
                maxlength: 64,
                notEqualTo: '#signup-firstname, #signup-lastname, #signup-email'
            }
        }, 
        messages: {
            firstname: {
            ...
            username: {
                ...
                minlength: "Username must be more than 4 characters in length.",
    ...
    $([]).add($signup).add($login).on('submit', function(e) {
        ...
        if ($form.valid()) {
            ...
            .fail(function() {
                ...
                $form.data('disabled', false).removeClass('processing');
                $submit.removeAttr('disabled').text(text);
                alert('An error occured while communicating with the server. Please try again later, if the problem persists please contact our support team.');
            });
        }
